...
let AppRoot = class {
  ...
  render() {
    return (h("div", null, h("header", null, h("i", { class: "fas fa-home" }), h("h1", null, "Property Inspection Form")), h("main", null, h("stencil-router", null, h("stencil-route-switch", { scrollTopOffset: 0 }, h("stencil-route", { component: "app-home" }))))));
  }
};
